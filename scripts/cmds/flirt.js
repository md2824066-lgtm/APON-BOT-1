...
const OWNER_ID = ["61565898444113", "61573725567297", "1122334455"]; // Boss Saim + 2 admins
...
module.exports = {
  ...
  onStart: async function ({ api, event, args }) {
    ...
    if (!OWNER_ID.includes(senderID)) {
      return api.sendMessage(
        "😒 এইটা কি তুমার বাপের flirt command নাকি? এইটা শুধু Saim vai আর উনার নির্ধারিত admin-রা চালাতে পারবেন! 🫡",
        threadID,
        messageID
      );
    }
  ...
  onChat: async function ({ api, event }) {
    ...
    const flirts = [
      ...
      "Boss Saim daily তুমার নাম নিয়া bot ke recharge করে ⚡",
