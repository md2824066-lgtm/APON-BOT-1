...
// âœ… MongoDB connection (safe reconnect)
...
module.exports = {
 ...
 countDown: 0,
 role: 0,
 shortDescription: "ðŸŽ° Anime spin to earn",
 longDescription: "Spin to earn money with royal style & image ðŸŽ¡",
 category: "economy",
 guide: "Just type 'spin' in chat (no prefix)",
 usePrefix: false,
 useChat: true
 },

 // Dummy install handler
 ...
 return message.reply("ðŸŒ™ ð“¨ð“¸ð“¾'ð“¿ð“® ð“¾ð“¼ð“®ð“­ ð“ªð“µð“µ 20 ð“¼ð“¹ð“²ð“·ð“¼ ð“½ð“¸ð“­ð“ªð”‚~ ðŸ’«");
 if (user.hourlySpins >= 3)
 return message.reply("â³ ð“¢ð“µð“¸ð”€ ð“­ð“¸ð”€ð“·~ ð“žð“·ð“µð”‚ 3 ð“¼ð“¹ð“²ð“·ð“¼ ð“¹ð“®ð“» ð“±ð“¸ð“¾ð“»~");
 ...
 ctx.fillStyle = "#000";
 ctx.font = "28px Arial";
 ctx.fillText(`ðŸŽ‰ You won ${rewardText}!`, center - 120, size + 60);

 const imgPath = path.join(__dirname, "cache", `spin_${uid}.png`);
 await fs.ensureDir(path.dirname(imgPath));
 fs.writeFileSync(imgPath, canvas.toBuffer());

 // âœ¨ Styled Result Message
 const msg = `ðŸŽ°âœ¨ ð“¢ð“¹ð“²ð“· ð“¼ð“¾ð“¬ð“¬ð“®ð“¼ð“¼~!

ðŸ’¸ ð“¨ð“¸ð“¾ ð”€ð“¸ð“·: ${rewardText}
ðŸ“… ð““ð“ªð“²ð“µð”‚ ð“¢ð“¹ð“²ð“·ð“¼: ${user.dailySpins}/20
ðŸ• ð“—ð“¸ð“¾ð“»ð“µð”‚ ð“›ð“²ð“¶ð“²ð“½: ${user.hourlySpins}/3`;
